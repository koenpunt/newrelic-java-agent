...
abstract class WorkerSourceTask_Instrumentation {
    ...
    @Trace(dispatcher = true, metricName = "MessageBroker/Kafka/Connect/WorkerSourceTask/poll")
    ...
    @Trace(async = true, metricName = "MessageBroker/Kafka/Connect/WorkerSourceTask/sendRecords")
